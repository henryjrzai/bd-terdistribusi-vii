                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">NIIM</th>
                                ...
                                <?php
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">'.$d['nim'].'</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-xs font-weight-bold mb-0">'.$d['tanggal_lahir'].'</p>
                                    </td>
                                    <td class="align-middle text-center">
                                        <p class="text-xs font-weight-bold mb-0">'.$d['jurusan'].'</p>
                                    </td>
                                    <td class="align-middle text-center">
                                    ...
                                    <td class="align-middle text-center">
                                        <p class="text-xs font-weight-bold mb-0">'.$d['tahun_masuk'].'</p>
                                    </td>
                                    <td class="align-middle text-center">
                                        <p class="text-xs font-weight-bold mb-0">'.$d['ipk'].'</p>
                                    </td>
